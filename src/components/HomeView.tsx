...
export default function HomeView({ setActiveTab }: HomeViewProps) {
  ...
  return (
    ...
    >
      ...
      <section className="px-6 md:px-12 max-w-5xl mx-auto pt-32 md:pt-40">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 items-center">
          ...
          <div className="md:col-span-8 space-y-6">
            <div className="inline-flex items-center space-x-2 bg-zinc-900 border border-zinc-800/80 px-2.5 py-1 rounded text-[10px] font-mono uppercase tracking-widest text-zinc-400">
            ...
            <h1 id="hero-h1" className="text-4xl md:text-6xl font-black font-display text-white tracking-tight leading-none">
              ...
              <span className="text-zinc-500">Now I build my own.</span>
            </h1>
            ...
            <div className="pt-4 flex items-center space-x-4">
              <button
                ...
                className="bg-white text-black hover:bg-zinc-200 px-6 py-3.5 text-xs font-mono font-bold uppercase tracking-widest transition-all rounded cursor-pointer"
              >
                Get in Touch
              </button>
              <a
                href="#the-public-part"
                className="text-zinc-500 hover:text-white transition-colors text-xs font-mono uppercase tracking-widest flex items-center space-x-1.5"
              >
          ...
          <div className="md:col-span-4 flex justify-center">
            <div className="relative w-48 h-48 md:w-56 md:h-56 bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-900 rounded-2xl overflow-hidden flex flex-col justify-between p-6 shadow-2xl group">
              ...
              <div className="flex flex-col items-center justify-center space-y-3 relative z-10 my-4">
                <div className="w-14 h-14 rounded-full bg-zinc-950 border border-zinc-800 flex items-center justify-center text-zinc-400 group-hover:border-white transition-colors duration-500">
      ...
      <section id="the-public-part" className="px-6 md:px-12 max-w-5xl mx-auto border-t border-zinc-900 pt-20 scroll-mt-20">
        <div className="space-y-12">
          <div className="space-y-4 max-w-2xl">
            <span className="text-xs font-mono uppercase tracking-[0.2em] text-zinc-500 font-bold block">The Public Part</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {proofPoints.map((point, index) => (
              <div 
                key={index}
                className="bg-zinc-950 border border-zinc-900 rounded-xl p-6 hover:border-zinc-800 transition-all duration-350 flex flex-col justify-between space-y-4 relative overflow-hidden"
              >
                {/* Visual accent inside card */}
                <div className="absolute top-0 right-0 p-3 text-[9px] font-mono text-zinc-700 select-none">
                  [S.{index+1}]
                </div>

                <div className="space-y-2">
                  <div className="text-3xl md:text-4xl font-black font-display text-white tracking-tight">
                    {point.metric}
                  </div>
      ...
      <section className="px-6 md:px-12 max-w-5xl mx-auto border-t border-zinc-900 pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-4 space-y-3">
            <span className="text-xs font-mono uppercase tracking-[0.2em] text-zinc-500 font-bold block">What I'm Building</span>
          ...
          <div className="lg:col-span-8 bg-zinc-950 border border-zinc-900 p-8 rounded-2xl relative overflow-hidden space-y-6">
            ...
            <div className="absolute -right-24 -bottom-24 w-48 h-48 bg-zinc-800/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <section className="bg-zinc-950 border-y border-zinc-900 py-20 px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <span className="text-xs font-mono uppercase tracking-[0.2em] text-zinc-500 font-bold block">Fair Warning</span>
          <h2 className="text-2xl md:text-5xl font-black font-display text-white tracking-tight leading-tight max-w-3xl mx-auto">
            “I give my truthful, unfiltered two cents to anyone who asks. If you want a yes-man, I'm not your guy.”
          </h2>
      ...
      <section className="px-6 md:px-12 max-w-5xl mx-auto">
        <div className="space-y-12">
          <div className="border-b border-zinc-900 pb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div className="space-y-2">
              <span className="text-xs font-mono uppercase tracking-[0.2em] text-zinc-500 font-bold block">Audio & Publications</span>
              <h2 className="text-2xl md:text-3xl font-bold font-display text-white tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Card 1: TBE */}
            <div className="bg-zinc-950 border border-zinc-900 p-5 rounded-lg flex flex-col justify-between h-48 hover:border-zinc-800 transition-all">
              <div className="space-y-2">
      ...
      <section className="px-6 md:px-12 max-w-5xl mx-auto border-t border-zinc-900 pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-4 space-y-3">
            <span className="text-xs font-mono uppercase tracking-[0.2em] text-zinc-500 font-bold block">Working With Me</span>
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white tracking-tight">
              Advisory
            </h2>
          </div>
          ...
          <div className="lg:col-span-8 bg-zinc-950 border border-zinc-900 p-8 rounded-2xl space-y-6">
            <p className="text-zinc-200 text-sm md:text-base leading-relaxed font-sans font-light max-w-2xl">
              I take on a very small number of advisory engagements: operations, growth, and applied AI for real businesses. Engagements start at $5,000/month. If that number didn't scare you, get in touch.
            </p>
            <div className="pt-2">
              <button
                onClick={() => handleNavClick('/contact')}
      ...
      <section className="px-6 md:px-12 max-w-5xl mx-auto pt-12 pb-16">
        <div className="p-8 md:p-12 bg-zinc-950 border border-zinc-900 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
          ...
          <button
            onClick={() => handleNavClick('/contact')}
            className="bg-white text-black hover:bg-zinc-200 px-8 py-4 text-xs font-mono font-bold uppercase tracking-widest transition-colors rounded cursor-pointer shrink-0"
          >
            Get in Touch
          </button>
        </div>
